                        ...
                        <div className="relative bg-white dark:bg-gray-900 rounded-2xl shadow-2xl overflow-hidden">
                            ...
                            <div className=" bg-gradient-to-r from-[#47B083] to-[#3A9E75] text-white py-6 text-center relative">
                                ...
                                <div className="relative z-10 flex flex-col items-center">
                                    ...
                                    <ClipboardPen className="h-10 w-10 mb-2" />
                                    <h2 className="text-xl font-bold">Confirm Edit </h2>
                                </div>
                            </div>
                            ...
                            <div className="px-6 py-6 text-center">
                                <p className="text-gray-700 dark:text-gray-300">
                                    ...
                                    <span className="font-semibold dark:text-white text-[#3A9E75]">
                                        "this product"
                                    </span>
                                    ?
                                </p>
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
                                    This action change your product data.
                                </p>
